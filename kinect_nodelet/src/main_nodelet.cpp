...
***********************************/
    ...
    void PointCloudXyzrgbNodelet::onInit()
    {
     ...
     pub_point_cloud_ = depth_nh.advertise<PointCloud>("hello", 1, connect_cb, connect_cb);
  }
   ...
   void PointCloudXyzrgbNodelet::connectCb()
   {
     ...
     else if (!sub_depth_.getSubscriber())
     {
       ...
       sub_depth_.subscribe(*depth_it_, "/camera/depth/image_rect",       1, depth_hints);
   
       // rgb uses normal ros transport hints.
       image_transport::TransportHints hints("raw", ros::TransportHints(), private_nh);
       sub_rgb_  .subscribe(*rgb_it_,   "/camera/rgb/image_rect_color", 1, hints);
       sub_info_ .subscribe(*rgb_nh_,   "/camera/depth/camera_info",      1);
     }
   }
 ...
 PLUGINLIB_EXPORT_CLASS(kinect_nodelet::PointCloudXyzrgbNodelet, nodelet::Nodelet) ;
